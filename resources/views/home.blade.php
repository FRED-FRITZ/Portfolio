				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="asset/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span >Fred Fritz</span></span> </a>
					...
					<div class="user">
						...
						<div class="info">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route ('educationals.index')}}">
                                        <i class="la la-th"></i>
                                        <p>Educational</p>
                                        <span class="badge badge-count"></span>
                                    </a>
